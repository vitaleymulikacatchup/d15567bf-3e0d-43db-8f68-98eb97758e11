...
export const metadata: Metadata = {
  ...
  description: "Streamline operations, boost productivity, and scale with confidence using SaasFlow's powerful SaaS platform. Start your free trial today.",
  keywords: "SaaS platform, business automation, workflow management, team collaboration, analytics dashboard, API integration",
  openGraph: {
    title: "SaasFlow - Transform Your Business Operations",
    description: "Streamline operations, boost productivity, and scale with confidence using SaasFlow's powerful SaaS platform. Start your free trial today.",
    siteName: "SaasFlow",
    ...
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763541764050-kvvq3pnv.jpg",
        alt: "SaasFlow dashboard demonstration"
      }
    ]
  },
  twitter: {
    ...
    title: "SaasFlow - Transform Your Business Operations",
    description: "Streamline operations, boost productivity, and scale with confidence using SaasFlow's powerful SaaS platform.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763541764050-kvvq3pnv.jpg"]
  },
  robots: {
    index: true,
    follow: true
